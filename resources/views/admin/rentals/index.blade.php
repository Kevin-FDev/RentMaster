                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-sm text-gray-600 dark:text-gray-300">
                            ...
                            @php
                            // Normaliza o status para evitar problemas com maiúsculas ou espaços em branco do banco
                            $statusNormalizado = trim(strtolower($rental->status));
                            @endphp
                    ...
                    {{ $statusNormalizado === 'pendente' ? 'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-300' : '' }}
                    {{ $statusNormalizado === 'aprovado' ? 'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300' : '' }}
                    {{ $statusNormalizado === 'finalizado' ? 'bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-300' : '' }}
                    {{ $statusNormalizado === 'cancelado' ? 'bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-300' : '' }}
                ">
                                ...
                                <td class="p-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        @if(in_array($statusNormalizado, ['finalizado', 'cancelado']))
